          ...
          <div className="flip-card-inner">
            <div className="flip-card-front">
              <div className="boOfnS">
                ...
                <div className="bojiJp">
                  This platform allows you to perform transactions via
                  Blockchain by using Ethereum mainnet. Prerequisite: Web3.0
                  Wallet.
                </div>
              </div>
            </div>
            <div className="flip-card-back">
              <img
                src="https://firebasestorage.googleapis.com/v0/b/hareesh-e153f.appspot.com/o/projects%2Fkryptogiffy.jpg?alt=media&amp;token=b642f131-cdda-4378-9d2b-7f8770b1e671"
                alt="KryptoGiffy"
              />
              ...
              <footer className="iehvjW">
                <a
                  ...
                  href="https://kryptogiffy.web.app/"
                >
                  Visit
                </a>
                <a
                  className="sc-jJMGnK laKGqb"
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/hareesh-r/KryptoGiffy"
                >
                  <svg
                    aria-hidden="true"
                    data-prefix="fab"
